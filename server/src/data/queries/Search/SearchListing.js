...
import SearchSettings from '../../models/SearchSettings.js';
import CurrencyRates from '../../models/CurrencyRates.js';
import Currencies from '../../models/Currencies.js';
import searchListingType from '../../types/searchListingType.js';
...
if (dates && dates.toString().trim() !== '') {
  let noticeFilter = [], spiltDate = dates && dates.split("AND"), checkIn, checkOut, dayDifference;
