  ...
  up: (queryInterface, Sequelize) => {
    return Promise.all([
      ...
      queryInterface.bulkInsert('SiteSettings', [
        ...
        {
          title: 'Megasoft Merchant ID',
          name: 'merchentID',
          value: '3242',
          type: 'config_settings',
          createdAt: new Date('2025-06-16 14:14:54'),
          updatedAt: new Date('2025-06-16 14:14:54')
        },
        {
          title: 'Megasoft Username',
          name: 'username',
          value: 'blackpearl',
          type: 'config_settings',
          createdAt: new Date('2025-06-16 14:18:36'),
          updatedAt: new Date('2025-06-16 14:18:36')
        },
        {
          title: 'Megasoft Password',
          name: 'password',
          value: 'Caracas123.1',
          type: 'config_settings',
          createdAt: new Date('2025-06-16 14:19:01'),
          updatedAt: new Date('2025-06-16 14:19:01')
        },
        {
          title: 'Authorization Token',
          name: 'Token',
          value: 'YWRhc2lsdmE6TTNnYXNvZnQh',
          type: 'config_settings',
          createdAt: new Date('2025-06-16 14:19:42'),
          updatedAt: new Date('2025-06-16 14:19:42')
        }
      ]),
