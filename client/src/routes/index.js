  ...
  children: [
    ...
    },
    {
      ...
      load: () => new Promise((resolve, reject) => {
       ...
       {
      path: '/megasoft-success',
      load: () => new Promise((resolve, reject) => {
        resolve(require('./mainMegaSoft'));
        reject(error);
      }),
    },
    {
    ...
    {
      path: '/siteadmin/home/marketing',
      load: () => new Promise((resolve, reject) => {
        resolve(require('./siteadmin/marketingBanner'));
        reject(error);
      }),
    },
        {
      path: '/siteadmin/home/languages',
      load: () => new Promise((resolve, reject) => {
        resolve(require('./siteadmin/addLanguages'));
        reject(error);
      }),
    },
    {
    ...
    {
      path: '/siteadmin/payout-megasoft',
      load: () => new Promise((resolve, reject) => {
        resolve(require('./siteadmin/managePayoutMegasoft'));
        reject(error);
      }),
    },
    {
      path: '/siteadmin/view-payout-megasoft/:id',
      load: () => new Promise((resolve, reject) => {
        resolve(require('./siteadmin/viewPayoutMegasoft'));
        reject(error);
      }),
    },
    {
