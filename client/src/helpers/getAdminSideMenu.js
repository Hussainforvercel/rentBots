...
export function getAdminSideMenu(formatMessage, location) {
    ...
    let sideMenuData3 = [
        ...
        {
            menuLocation: "/siteadmin/payout-megasoft",
            menuName: "Megasoft Payout Management",
            activeLocation: (location === "/siteadmin/payout-megasoft"),
            icon: payOutManagementIcon,
            iconAltText: 'payOutManagementIcon',
            isValidatePrivilege: true,
            privilegeId: 11
    ...
    let sideMenuData5 = [
        ...
        {
            menuLocation: "/siteadmin/home/marketing",
            menuName: formatMessage(messages.bannerCaptionLabel2),
            activeLocation: (location === "/siteadmin/home/marketing"),
            icon: arrowIcon,
            iconAltText: 'arrowIcon',
            isValidatePrivilege: false,
        },
          {
            menuLocation: "/siteadmin/home/languages",
            menuName: formatMessage(messages.adminLanguages),
            activeLocation: (location === "/siteadmin/home/languages"),
            icon: arrowIcon,
            iconAltText: 'arrowIcon',
            isValidatePrivilege: false,
        },
