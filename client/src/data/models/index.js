...
import PaymentGuideModel from './siteadmin/PaymentGuide.js'
const PaymentGuide = PaymentGuideModel(sequelize);
...
import PayoutMegasoft from './payouts-mega'
...
// PayoutMegasoft associations
PayoutMegasoft.belongsTo(Listing, {
  foreignKey: 'buyerId',
  targetKey: 'id',
  as: 'listing',
  onUpdate: 'cascade',
...
import AdminModel from './siteadmin/AdminModel';
