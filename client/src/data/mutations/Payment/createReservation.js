...
const createReservation = {
  ...
  args: {
    ...
    megasoftVoucher: { type: StringType },
    isHourly: { type: BooleanType },
  },
  async resolve(
    { request, response },
    {
    ...
    try {
      ...
      if (request.user && !request.user.admin) {
        ...
        // For Megasoft payments (paymentType 3,4,5,6,7), set reservationState to approved
        ...
        const reservation = await Reservation.create({
          ...
          paymentState: (paymentType >= 3 && paymentType <= 7) ? 'completed' : 'pending',
          cancellationPolicy,
          isSpecialPriceAverage,
          dayDifference,
          startTime,
