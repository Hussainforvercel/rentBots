      ...
      <div className={cx(s.stepGrid, 'stepGridRTL')}>
        ...
        <form onSubmit={handleSubmit}>
          <div className={s.landingMainContent}>
            ...
            <FormGroup className={cx(s.space1)}>
              <ControlLabel className={s.landingLabel}>
            ...
            <FormGroup className={cx(s.noMargin)}>
              <Field
                ...
                label={formatMessage(messages.basePriceLabel2)}
            ...
            <div className={cx(s.pricingTypeContainer)}>
              <FormGroup className={cx(s.pricingTypeGroup)}>
              <ControlLabel className={s.landingLabel}>
                    <FormattedMessage {...messages.dailyPricing} />
                  </ControlLabel>
                  <Field
                    name="hourlyPrice"
                    type="text"
                    component={CommonFormComponent}
                    label={formatMessage(messages.hourPriceLabel2)}
                    inputClass={cx(s.formControlInput, s.jumboSelect, s.formControlInputMaxWidth)}
                    normalize={normalizePrice}
                  />
</FormGroup>
